...
│   │   └── sweet.controller.js
│   │       → Handles sweets CRUD, purchase & restock logic
│
│   ├── middleware/
│   │   ├── auth.middleware.js
...
│   │   └── Sweet.js
│   │       → Sweet schema (name, category, price, quantity)
│
│   ├── routes/
│   │   ├── auth.routes.js
...
│
├── .env
│   → Environment variables (DB URI, JWT secret)
│
├── package.json
...
Admin → Full inventory control (add/update/delete/restock)
